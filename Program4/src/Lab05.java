...
public class Lab05
{
	public static void main(String[] args)
	{
		...
		// Make suggestion
		if (spicy)
			if (fancy) System.out.println("I suggest you go to Thai Garden Palace.");
			else System.out.println("I suggest you go to Alberto's Tacqueria.");
		else if (fancy) System.out.println("I suggest you go to Chez Paris.");
		else System.out.println("I suggest you go to Joe's Diner.");
